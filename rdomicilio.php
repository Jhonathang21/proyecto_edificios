...
<html>
<head>
	<title>REGISTRO DOMICILIOS</title>
...
<div class="panel panel-primary">
	<div class="jumbotron">
		  ...
		  <div class="form-group">
		    <label>Empresa</label>
		    <input type="text" class="form-control" id="empresa" name="empresa" placeholder="Empresa Domicilio">
		  </div>
		  <div class="form-group">
		    <label>Fecha </label>
	...
	$(document).ready(function(){
		$('#registrar').click(function(){
			...
			if($('#cedula').val()==""){
				...
				alertify.alert("Debes agregar el nombre de la empresa del domicilio");
				return false;
